...
void replaceSuccessors(Instruction *Terminator,
...
// Explicit instantiations for `replaceSuccessors` helper
template void
replaceSuccessors<SmallVector<BasicBlock *>>(Instruction *Terminatorm,
                                             SmallVector<BasicBlock *>
                                               &NewSuccessors,
                                             BasicBlock *Parent);
template void
replaceSuccessors<SmallSet<BasicBlock *, 4>>(Instruction *Terminatorm,
